...
Charset.  ECI Mode Segments are created by SetECI, ShouldSetECI,
MustSetECI and Text.  StructAppend Mode Segments are generated by
SplitMulti.
...
// bare UTF-8 text.  Function Text constructs Data for other common
// scenarios.
func Split(data Data, level coding.Level, format Format) ([]coding.Segment, coding.Version, error) {
	...
	if level < L || level > H || level == H && format == Micro {
...
//	n  0x01  numeric mode
//
// chartbl is used by some Classifier functions asciiCompat.classify,
